...
// 變數定義
	...
	// 定義按鈕圖片
	private ImageIcon Shop_icon;
	private Image scaled_Shop_icon;
	private ImageIcon shop_icon;
	private ImageIcon Character_icon;
	private Image scaled_Character_icon;
	private ImageIcon character_icon;
	private ImageIcon Bag_icon;
	private Image scaled_Bag_icon;
	private ImageIcon bag_icon;
	private ImageIcon Stage_icon;
	private Image scaled_Stage_icon;
	private ImageIcon stage_icon;
	...
	void setGameMainPage() {
		...
		// 設置按鈕圖片
		Shop_icon = new ImageIcon("image/shop.png");
		scaled_Shop_icon = Shop_icon.getImage().getScaledInstance(Width, Height, Image.SCALE_SMOOTH);
		shop_icon = new ImageIcon(scaled_Shop_icon);
		Character_icon = new ImageIcon("image/character.png");
		scaled_Character_icon = Character_icon.getImage().getScaledInstance(Width, Height, Image.SCALE_SMOOTH);
		character_icon = new ImageIcon(scaled_Character_icon);
		Bag_icon = new ImageIcon("image/bag.png");
		scaled_Bag_icon = Bag_icon.getImage().getScaledInstance(Width, Height, Image.SCALE_SMOOTH);
		bag_icon = new ImageIcon(scaled_Bag_icon);
		Stage_icon = new ImageIcon("image/stage.png");
		scaled_Stage_icon = Stage_icon.getImage().getScaledInstance(90, 120, Image.SCALE_SMOOTH);
		stage_icon = new ImageIcon(scaled_Stage_icon);
